...
class MeshPlotRenderer:
    ...
    def plot_p2p(mesh1, mesh2, p2p, rotation=None, pretty=True, rev=False, shading=None, n_colors=-1,
        ...
        return MeshPlotRenderer.double_plot(mesh1, mesh2, cmap1=cmap1, cmap2=cmap2, rotation=rotation, shading=shading_m)

    def plot_texture(vertices, faces, uv, wireframe=False, multiple_sides=False):
